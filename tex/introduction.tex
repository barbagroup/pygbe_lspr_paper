...
a proprietary finite-element platform ({\color{red}cite COMSOL Multiphysics® v. 5.2. www.comsol.com. COMSOL AB, Stockholm, Sweden.}), 
BEM++ ({\color{red}Not sure how to cite}) an open-source Boundary element method library to solve time-harmonic Maxwell equations in 3D, and 
MNPBEM, an open-source Matlab toolbox for the simulation of metallic nanoparticles that
uses BEM. Besides, on the biosensing approach, the biomolecular electrostatic 
implementation of \pygbe \cite{CooperETal2016}} allowed the study of ligand 
molecule orientation sensor \cite{CooperClementiBarba2015}.
...
affects the sensitivity of the sensor (Haes, A. J., Zou, S., Schantz, G. C., and
Van Duyne, R. P. (2004). A nanoscale optical biosensor: The long range distance
dependence of the localized surface plasmon resonance of noble metal nanoparticles.
 J. Phys. Chem B, 108:109–116.)
