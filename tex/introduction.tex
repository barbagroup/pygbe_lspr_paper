...
Progress in biosensor research is predominantly made
...
Other experimental studies complemented by modeling fully ignore the presence target molecule.
...
Explicitly including the target molecules may be needed in some cases.
Despite experimental evidence showing that LSPR sensors are sensitive enough to detect 
