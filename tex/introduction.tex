...
Explicitly including the target molecules in the model may be needed in some cases.
...
is accelerated algorithmically via a treecode---an $\mathcal{O}(N\log N)$ fast summation method---
and on hardware by taking advantage of graphic processing units (GPUs). 
