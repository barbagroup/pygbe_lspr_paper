...
for which the extinction cross-section can be derived in closed form.
The second set of results use a model for a biosensor detecting a large molecule, 
...
for the isolated nanoparticle, and in the presence of bovine serum albumina (BSA) proteins, 
