...
\begin{figure}%[h] %  figure placement: here, top, bottom, or page
   ...
   \caption{Extinction cross-section as a function of wavelength for an $8$-nm
            ...
            $z$-direction, and at infinity (no protein). For the distance of $d=0.5$ nm, there is a possibility that quantum effects are present (not caputured by the model). However, based on the existing literature it is not clear wether they are or not present in our case \cite{SavageETal2012, EstebanETal2012}.
            }
