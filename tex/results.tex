...
\begin{figure}%[h] %  figure placement: here, top, bottom, or page
   ...
   \caption{Extinction cross-section as a function of wavelength for an $8$-nm
            ...
            $z$-direction, and at infinity (no protein). The test case with $d=0.5$nm is close to the limit where tunneling might happen. Such quantum effects would not be appreciated here, as our model is purely classical.}
