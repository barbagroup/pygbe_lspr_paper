...
The percentage errors for the different meshes are presented in Table. \cite{table:err_iso_sphere}.
...
\begin{figure}[h] %  figure placement: here, top, bottom, or page
   ...
   \caption{Extinction cross-section as a function of wavelength fo a $8 \, nm$
