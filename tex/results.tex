...
and co-workers \cite{TeichroebETal2008}, who report a coverage of $2x10^{12} \quad \text{molecules}/cm^2$  
or $3.3x10^{12} \quad \text{molecules}/cm^2$ for a sphere 15-nm in diameter, depending 
...
two BSA dimers in the proximity of the sensor, the concentrations are thus similar. In
support of the reproducibility of our results, we deposited the final meshes in the Zenodo data repository.
See section \ref{sec:repro} for details.
