...
%
 ...
 \end{equation}
%
Equation \eqref{eq:integral_eq_lspr_nobc_system} can be represented as:
%
...
\begin{align} \label{eq:dip_gauss_interm_2}
 - \frac{\mathbf{p_i}}{\epsilon_2} =& \oint_\Gamma  x_i  \frac{\partial \phi_{2s}}{\partial n} \text{d}\Gamma - \nonumber \\
