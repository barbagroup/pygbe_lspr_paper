...
\begin{itemize}
    ...
    \item Functions added:
        \item read_electric_field : Reads the electric field intensity and its wavelength from config files.
        \item dipole_moment : Computes numerically the dipole moment (Eq. \eqref{eq:dipole_def_gauss_i_final})
        \item extinction_cross_section: Computes the the extinction cross section.
