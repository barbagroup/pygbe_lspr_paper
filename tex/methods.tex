The original implementation of \pygbe used continuum electrotatic theory to compute
...
\begin{figure}[h] %  figure placement: here, top, bottom, or page
    ...
    \caption{Analyte-sensor system under electric field.\textcolor{blue}{I think we should draw arrows representing the E field}}
